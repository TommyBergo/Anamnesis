...
/** Composable screen for the chat conversation: message list, input bar, and dialogs for audio-file/model-switcher selection and load errors. */
...
fun ChatScreen(
    ...
    val pdfPickerLauncher = rememberLauncherForActivityResult(
        ...
        uri?.let { viewModel.processAndStoreClinicalRecord(it) }
    }
