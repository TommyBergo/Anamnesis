...
/** Holds the full palette of theme-dependent colors used throughout the app's UI. */
...
val DarkAppColors = AppColors(
    ...
    chatBackground = Color(0xFF16293D),
...
/** Composable that provides the Material3 color scheme and app-specific [AppColors] palette for either dark or light theme. */
@Composable
fun LlamaDemoTheme(
