...
/** Tracks a preset model's download and readiness state: model file, tokenizer file, in-progress download, and any error. */
...
/** Tracks the loading state of a custom preset-config URL. */
...
/** View model that downloads, tracks, and loads preset models, optionally sourced from a custom remote config URL. */
