...
/** Retrieval AND generation evaluation for [TfIdfRagEngine] - the paper's standalone TF-IDF retrieval configuration (Table 3's "TF-IDF" row) - using the same pipeline/scoring as the other engine evaluation tests. */
@RunWith(AndroidJUnit4::class)
class SimpleJsonRagEvaluationTest {

    companion object {
        private const val TAG = "SimpleJsonRagTest"
...
""".trimStart()
    ...
    @Test
    fun runSimpleJsonRagEvaluation() {
        val targetContext = InstrumentationRegistry.getInstrumentation().targetContext
        val testContext = InstrumentationRegistry.getInstrumentation().context
    ...
    private fun writeResultsJson(
        ...
        val outFileName = "simple_json_rag_results.json"
