...
/** Multi-document evaluation of [Bm25RagEngine] against `QA/multidoc_dataset_llm_main_same_patient.jsonl`, the lexical-retrieval counterpart to [MultiDocRagEvaluationTest]. */
@RunWith(AndroidJUnit4::class)
class MultiDocBm25RagEvaluationTest {

    companion object {
        private const val TAG = "MultiDocBm25RagEvalTest"
...
""".trimStart()
    ...
    @Test
    fun runMultiDocBm25RagEvaluation() {
        val targetContext = InstrumentationRegistry.getInstrumentation().targetContext
        val testContext = InstrumentationRegistry.getInstrumentation().context
    ...
    private fun writeResultsJson(
        ...
        val outFileName = "multidoc_bm25_rag_results.json"
